...
import { Shield, Scan, AlertTriangle, Settings, Database, Users, Activity, Clock, Zap } from 'lucide-react';
...
const DinosaurKingAntivirus = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-teal-900 to-emerald-900">
      {/* Header */}
      <div className="bg-slate-800/90 backdrop-blur-sm border-b border-amber-200/20">
